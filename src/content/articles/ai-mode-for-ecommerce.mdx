...
<MistakeGrid>
  <Mistake num="01" title="Treating AI Mode and AI Overviews as one thing">
  ...
  <Mistake num="02" title="Passing data from one surface off as the other">
    It happens most often with Search Console impressions, which are reported in aggregate.
  </Mistake>
  <Mistake num="03" title="Relying on the manufacturer's description">
    It adds nothing to a comparison that your competitors don't also have. The value is in what you add.
  </Mistake>
  <Mistake num="04" title="A mismatch between the page and the feed">
